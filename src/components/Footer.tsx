...
export default function Footer() {
  return (
    <footer className="bg-white border-t border-gray-100/80">
      {/* CTA strip */}
      <div className="border-b border-gray-100/80 bg-gradient-to-r from-primary/5 via-transparent to-primary/5">
      ...
      <div className="mx-auto max-w-7xl px-6 sm:px-8 py-16 grid gap-12 sm:grid-cols-2 lg:grid-cols-5">
        <div className="lg:col-span-2">
          ...
          <div className="mt-6 flex flex-col gap-2.5 text-sm text-gray-500">
          ...
          <div className="flex flex-wrap gap-2">
            {socials.map(({ label, href, Icon }) => (
              <a
                ...
                rel="noreferrer"
                aria-label={label}
                className="h-11 w-11 grid place-items-center rounded-full border border-gray-200 bg-white hover:border-primary hover:text-primary hover:shadow-md transition-all duration-200"
              >
                <Icon size={18} />
              </a>
            ))}
